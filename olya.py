...
bot = telebot.TeleBot("7925208429:AAHjxcHbxgDDAFdSNZt_zb0zhObm-UoIKSI")
...
def handle_photo(message):
    # message.photo - это список размеров. Последний [-1] — самый четкий.
    photo_id = message.photo[-1].file_id
    bot.reply_to(message, f"ID этой фотки:\n{photo_id}")
